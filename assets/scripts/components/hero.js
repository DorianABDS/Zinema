...
export async function renderHeroSection() {
  ...
  hero.id = 'hero';
  hero.className = 'relative w-full h-[100vh] bg-cover bg-center text-white flex items-center transition-all duration-1000';
  ...
  content.className = 'relative z-10 text-left px-8';
